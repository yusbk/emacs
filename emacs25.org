...
Cursor move first line or block. Diambil di [[http://ergoemacs.org/emacs/emacs_keybinding_design_beginning-of-line-or-block.html][Ergoemacs]].
...
#+BEGIN_SRC emacs-lisp
  (use-package crux
    :ensure t
    :bind(
          ;; ("C-a" . crux-move-beginning-of-line) ;matikan sebab pakai xah-beginning-of-line-or-block
...
#+BEGIN_SRC emacs-lisp
  (use-package ess-site
    ...
    (:map ess-mode-map ;ESS
          ("C-c s" . run-shiny-app)
          ("C-a" . xah-beginning-of-line-or-block) ;cara lain boleh pakai crux-move-beginning-of-line
