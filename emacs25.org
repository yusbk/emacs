...
#+BEGIN_SRC emacs-lisp
  (use-package info+
    :load-path "~/Dropbox/customize/lisp/"
    :defer 1
    :after info)
#+END_SRC
...
#+END_SRC
** Personal elisp
Semua pakej yang dimuatkan sendiri

#+BEGIN_SRC emacs-lisp
  (add-to-list 'load-path "~/Dropbox/customize/lisp")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (use-package bookmark
    ...
    (add-to-list 'load-path "~/Dropbox/customize/lisp/bookmark+/")
