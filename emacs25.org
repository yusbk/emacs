...
#+BEGIN_SRC emacs-lisp :tangle yes
  (use-package flyspell
    ...
    (key-chord-define-global "jx" #'hydra-kamus/body)
  ...
  (eval-after-load 'ess-mode
    '(progn
       (defhydra ybk-r-debug (:color teal :hint nil)
         ...
         ^--------------^-------------------------^----------------------
         _o_: object     _m_: create  _t_: test    _b_: set    _k_: kill
         _a_: devtools   _l_: load    _c_: check   _n_: next   _K_: kill all
                       ^^_d_: doc                ^^_p_: prev
         "
         ...
         ("m" ess-r-devtools-create-package)
