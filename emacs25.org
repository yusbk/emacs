...
dengan =Ctrl-TAB= utk buka snippet.
...
#+BEGIN_SRC emacs-lisp
  (defhydra hydra-ybk-general (:hint nil)
    "
     ...
     ^-------------------------------
     _y_: ybk-init  _g_: highlight        _s_: stackOverflow  _w_: swap-windows       _e_: musics (emms)   _x_: save buffers & exit  _p_: powerline separator
