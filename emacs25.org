...
#+BEGIN_SRC emacs-lisp
  ...
  ;;      (bind-key "x" #'ess-dev-map 'ybk/r-map)
  ;;      (bind-key "y" #'ess-r-package-dev-map 'ybk/r-map)
    ...
    '(progn
       (defhydra ybk-r-debug (:color teal :hint nil)
         "
          ...
          ^---^----------^---^----------^---^----------^---^---------------------------
          _._: Object    _n_: Next BP   _k_: Kill BP   _l_: Load PKG   _d_: doc PKG
...
#+BEGIN_SRC emacs-lisp
  (use-package polymode
    ...
    (defhydra ybk-rmd (:hint nil)
      "
     ^RMarkdown keys^  [_q_: Keluar]
     ^--^----------------^--^-------------^--^---------------^--^-------------
     _c_: Insert chk   _t_: Eval buffer _f_: Fold chk    _a_: Fold all chk  _n_: next chk     _k_: kill chk
     _r_: Evaluate chk _d_: Create doc  _u_: Unfold chk  _e_: Export M-n-e  _p_: previous chk
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (defhydra ybk-keymap-org (:hint nil)
    "
    ^Org-keymap [F6] or qq^   [tekan _q_ utk KELUAR]
    ^-------------------------------------------------
    ...
    _w_: today          _t_: google-translate  _s_: org option (sparse)   _n_: meeting note
    _d_: TODO           _p_: gambar/pic        _c_: bibtex                _m_: meeting done
  ...
  (key-chord-define-global "qq" #'ybk-keymap-org/body)
#+END_SRC
