...
#+BEGIN_SRC emacs-lisp
  (defhydra hydra-ybk-prog (:hint nil)
    ...
    ^Project^          ^SEXP^            ^misc^                   ^kode^                ^extra^
    ^---------------------------------------------------------------------------------------------------
    _P_: Projectile    _a_: start exp    _k_: kill other buffers  _g_: Magit            _r_: knitr
    _p_: find project  _e_: end exp      _y_: Yasnippet           _d_: Ediff            _R_: debug R
