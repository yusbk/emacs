...
untuk dapatkan semua kekunci. Hydra utk ess-debug pakai =jk= atau =F9=
...
#+BEGIN_SRC emacs-lisp
  (defhydra hydra-ybk-general (:hint nil)
    "
     ...
     ^-------------------------------
     _y_: ybk-emac     _g_: highlight        _s_: stackExchange  _w_: swap-windows       _d_: musics          _x_: save buffers & exit
     _h_: heading      _l_: warna highlight  _r_: rss            _n_: file explore [F4]  _c_: weather
     _t_: tukar theme  _m_: menu bar         _o_: scratch        _k_: delete file/buffer _b_: weather update  _q_: KELUAR
...
#+BEGIN_SRC emacs-lisp
  (defhydra ybk-map-move (:hint nil)
    ...
    ^Misc^                                 ^Bookmarks^          ^Register^
    ^--------------------------------------^---------^----------^--------^-----------------------------------------------
    _+_: resize window  _h_: doc heading  _m_: bookmark set  _SPC_: reg set       _r_: mark set    _a_: mark show       _s_: search
    _w_: select window  _o_: imenu        _t_: bookmark-goto   _j_: reg jump      _n_: mark next   _A_: mark show all
    _b_: move buffer    _g_: goto         _J_: bookmark jump   _l_: bookmark list _p_: mark prev   _x_: mark remove all _q_: KELUAR
    "
    ("+" resize-window)
    ("w" winum-select-window-by-number)
...
#+BEGIN_SRC emacs-lisp
  (defhydra hydra-ybk-prog (:hint nil)
    ...
    _o_: Origami       _u_: unwrap exp   _-_: del unuse yas.      _f_: diff-walker
