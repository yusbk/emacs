...
#+BEGIN_SRC emacs-lisp :tangle yes
  (use-package powerline
    ...
    ;; yus-theme
    (defface yus-aktif1 '((t (:background "#a25fff" :inherit mode-line))) ;#a2e #2a5289 #4c52ee #179 #cfdfff #00d9ff #19a
      "Powerline muka 1."
      :group 'powerline)
...
#+END_SRC
*** Premable dan header font size
Tetapkan premable size walaupun tukar theme. Diambil di [[https://emacs.stackexchange.com/questions/22584/disable-enlarged-org-mode-header-appearance][sini]].
...
#+BEGIN_SRC emacs-lisp
  ...
  (custom-set-faces
   ...
   '(org-document-title ((t (:foreground "#ffc58f" :weight semi-bold :height 1.0))))
   )

  ;; === size utk header
  (defun ybk/org-mode-hook ()
  ...
  (add-hook 'org-mode-hook 'ybk/org-mode-hook)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun ybk/log-file ()
    "Buka log file di folder doc"
    (interactive)
    (find-file (expand-file-name R-log-file
...
#+BEGIN_SRC emacs-lisp
  (defhydra hydra-ybk-r-debug (:hint nil)
    "
     ...
     ^--------------^-----------------------^---------------------------^--------------
     _o_: object     _l_: load  _t_: test    _b_: set    _k_: kill       _r_: test-fun
