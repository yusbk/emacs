...
#+BEGIN_SRC emacs-lisp
  (use-package yasnippet
    ...
    :bind (("C-x y" . aya-open-line) ;masukkan abbrev atau snippet sekiranya ada
           :map ybk/prog-map
           ("y" . company-yasnippet))
    ...
    (global-set-key "\C-x y" 'aya-open-line)
    )
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package origami
    ...
    ;; Tetapkan ess-mode pakai sama seperti C
    ;; utk tetapkan parser sendiri seperti boleh tambah di "origami-parser-alist"
    ;; (setq origami-parser-alist (sendiri-punya .,(origami-markers-parser "{{" "}}")))
    ;; (ess-mode . origami-c-style-parser)
...
#+END_SRC
* Google-translate
Untuk pakai fungsi =Google Translate= di GNU Emacs. Sila lihat sumber di[[https://github.com/atykhonov/google-translate][sini]]. Untuk
tukar terjemahan boleh pakai =C-n= atau =C-p=.

#+BEGIN_SRC emacs-lisp
  (use-package google-translate
    :ensure t
    :bind (:map ybk/org-map
                ("g" . hydra-google-trans/body))
    :init
    ;;Hydra
    (defhydra hydra-google-trans (:color blue)
      "Google-translate"
      ("t" google-translate-smooth-translate "pilih terjemahan")
      ("p" google-translate-at-point "terjemah BI-BM")
      ("h" google-translate-query-translate "tulis perkataan")
      ("q" nil "keluar")))
#+END_SRC
** Smooth-UI
...
#+END_SRC
** Default-UI
Sekiranya bahasa tidak sedia ditetapkan di 'Smooth UI' boleh pilih dari pilihan pelbagai bahasa.
#+BEGIN_SRC emacs-lisp
  (use-package google-traslate-default-ui
    ...
    :init
    (setq google-translate-default-target-language "ms")
