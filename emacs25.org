...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  If OTHERS is true, skip all entries that do not correspond to TAG."
    ...
    ;; Display format
    (setq org-agenda-prefix-format '((agenda  . "%-10 s%?-2t") ; (agenda . " %s %-12t ")
                                     (timeline . "%-9:T%?-2t% s")
             ...
             ((agenda ""
              ...
              (todo "TODO"
                    ((org-agenda-max-entries 20)
                     ...
                     ;; (org-agenda-skip-function '(zin/org-agenda-skip-tag "REFILE" nil)) ;skip REFILE
                     (org-agenda-skip-function '(zin/org-agenda-skip-tag "PRIVAT" nil)) ;skip REFILE
                     ))
              (tags "REFILE"
