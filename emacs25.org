...
#+BEGIN_SRC emacs-lisp
  (use-package google-translate
    ...
    (defhydra hydra-google-trans (:color blue
                                         :columns 6)
      "Google-translate"
      ("t" google-translate-smooth-translate "terjemahan BM")
      ("e" google-translate-at-point "terjemah NO-BI")
      ("m" google-translate-at-point-reverse "terjemah BI-NO")
      ("p" google-translate-query-translate "perkataan NO-BI")
      ("o" google-translate-query-translate-reverse "perkataan BI-NO")
      ("q" nil "keluar")))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (use-package google-translate-default-ui
    ...
    (setq google-translate-default-target-language "en") ;terjemah ke
    (setq google-translate-default-source-language "no") ;terjemah dari
    )
#+END_SRC
