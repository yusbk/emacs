...
#+BEGIN_SRC emacs-lisp
  (defhydra hydra-ybk-prog (:hint nil)
    "
    ^Programming keymap: [F12] or jx^  [_q_ keluar]
    ^----------------------------------
    _p_: Projectile     _a_: start exp    _x_: kill exp        _o_: Origami
    _f_: Find project   _e_: end exp      _y_: Yasnippet       _w_: Send2browser
  ...
  ;; ikut urutan huruf
  (key-seq-define-global "jx" 'hydra-ybk-prog/body)
#+END_SRC
