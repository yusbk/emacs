...
#+BEGIN_SRC emacs-lisp :tangle yes
  (use-package org-agenda
    ...
    ;;                  (org-agenda-overriding-header "Alle TODO")
    ;;                  (org-agenda-skip-function 'my-skip-reg)))
    ;;           (tags "REGISTER"
    ;;                 ((org-agenda-max-entries 10)
    ;;                  (org-agenda-overriding-header "Oppgaver med Register")
    ;;                  (org-agenda-skip-function '(org-agenda-skip-entry-if 'todo 'done)))) ;skip if TODO keyword marked DONE
    ;;           ))))

    ;; Display (the commented one is default)
    ;; (setq org-agenda-prefix-format '((agenda . " %i %-12:c%?-12t% s")
    ;;                                  (timeline . " % s")
    ;;                                  (todo . " %i %-12:c") ; 'c' masukkan Namafile dan 'T' tags seperti dibawah
    ;;                                  (tags . " %i %-12:c")
    ;;                                  (search . " %i %-12:c")))

    (setq org-agenda-prefix-format '((agenda  . "%-10:T% s%?-2t") ; (agenda . " %s %-12t ")
                                     (timeline . "%-9:T%?-2t% s")
                                     ;; (todo . " %i %?-12(concat \"[ \"(org-format-outline-path (list (nth 1 (org-get-outline-path)))) \" ]\") ")
                                     (todo . "%i%-8:T") ;%i%?-8:T tidak justify TODO
                                     (tags . "%i%-8:T")
                                     (search . "%i%-8:T")))
          ...
          '(("z" . "Personal agenda")
            ("y" "Agenda overview"
             ((agenda ""
              ...
              (todo "TODO"
                    ((org-agenda-max-entries 20)
                     (org-agenda-overriding-header "Andre oppgaver")
                     ))
              ))
            ("r" "REFILE" tags "REFILE"
             ((org-agenda-overriding-header "Usortert oppgaver")
              (org-agenda-skip-function '(org-agenda-skip-entry-if 'todo 'done)) ;skip if TODO keyword marked DONE
...
#+BEGIN_SRC emacs-lisp
  (use-package weather-metno
    ...
    :bind (:map ybk/map
                ...
                ("b" . weather-metno-forecast-location))
    :config
