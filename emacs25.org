...
#+BEGIN_SRC emacs-lisp
  (use-package polymode
    ...
    :config
    ;; Hydra
    (defhydra ybk-rmd (:color teal)
      "RMarkdown keys"
      ("c" rmd-insert-r-chunk "insert chunk")
      ("r" rmd-eval-chunk "eval chunk")
      ("t" rmd-eval-buffer "eval buffer")
      ("d" poly-ess-rmarkdown "create doc")
      ("q" nil "keluar")
      )
    (define-key ybk/prog-map "z" 'ybk-rmd/body)
    )
